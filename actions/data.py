...
recipes = {
    ...
    'Cacio e pepe': Munch.fromDict({
        ...
        'steps': [
            ...
            {'description': 'Meanwhile, the grated Pecorino in a bowl and add half cup of pasta cooking water.',
                'ingredients': [0]},
            {'description': 'Mix until you get a smooth cream. Add more water if needed.'},
            {'description': 'When the pasta is ready turn off the heat and add the Pecorino cream. Mix vigorously.',
                'ingredients': [1]},
    ...
    'Crepes': Munch.fromDict({
        ...
        'steps': [
            {'description': 'Break the eggs in a large bowl.', 'ingredients': [2]},
            {'description': 'Pour the milk and whisk until the eggs get incorporated in it.', 'ingredients': [2, 3]},
            {'description': 'Sift the flour over the bowl while mixing.', 'ingredients': [1]},
            ...
            {'description': 'Grease the pan with some butter.', 'ingredients': [0]},
